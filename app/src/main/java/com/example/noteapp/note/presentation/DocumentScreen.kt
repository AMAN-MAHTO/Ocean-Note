...
import com.example.noteapp.note.presentation.component.DeleteConfirmationDialogBox
import com.example.noteapp.note.presentation.component.ShareDialogBox
...
fun DocumentContentWrite(
    ...
    Column(
        ...
        Card(
            ...
            TextField(value = state.value.document.title,
        ...
        Card (
            ...
            TextField(value = state.value.document.body,
